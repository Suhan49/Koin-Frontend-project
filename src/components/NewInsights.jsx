...
function NewInsights() {
  return (
    <div className='bg-white pb-4 rounded-md'>
         <div className=" flex flex-row space-x-6 lg:space-x-16 pl-2 " >

          

          <div className="bg-gradient-to-r from-green-400 to-blue-500 p-8 text-white rounded-md mt-4 w-161 lg:w-117 h-36 flex space-x-6 ">
              <div>
        ...
        <div className="bg-gradient-to-r from-orange-400 to-red-500 p-8 text-white rounded-md mt-4 w-145 lg:w-110 h-36 flex space-x-4">
              <div>
             ...
             <div className="flex flex-col font-bold text-xl -mt-4"> 
                ...
                <span>tax liability</span>
                 <div className="bg-white  rounded-md  mt-2 mr-8">
                  <button className="text-black flex  text-[16px] p-2  mr-4 gap-2 ">
                    CheckNow
                    <img src="https://static.thenounproject.com/png/888647-200.png" className="size-5 mt-1"/>
                  </button>
                 </div>
