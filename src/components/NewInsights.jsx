...
function NewInsights() {
  return (
    <div className='bg-white pb-4 rounded-md'>
         <div className=" flex flex-row space-x-16 pl-12 " >
          <div className="bg-gradient-to-r from-green-400 to-blue-500 p-8 text-white rounded-md mt-4 w-117 h-36 flex space-x-6 ">
              <div>
        ...
        <div className="bg-gradient-to-r from-orange-400 to-red-500 p-8 text-white rounded-md mt-4 w-110 h-36 flex space-x-4">
              <div>
